                ...
                <div className="flex justify-between h-16 items-center">
                    <svg width="80" height="35" viewBox="0 0 80 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="logo_l0gik">
                            ...
                            <path className="pathLogo" id="Vector_7" d="M79.9999 28.1248L73.7485 18.5575L79.5106 9.7348H74.1652L68.6567 18.4831L74.6364 28.1248H79.9999Z" fill="white"></path>
                        </g>
                    </svg>

                    <nav className="hidden md:flex space-x-6">
                        <a href="#" className="text-white hover:text-[#00FF00]">Formulário</a>
                        <a href="#" className="text-white hover:text-[#00FF00]">Sobre</a>
                        <a href="https://l0gik.com.br/" className="text-white hover:text-[#00FF00]">Contato</a>
                        <a href="#" className="text-white hover:text-[#00FF00]">Painel Administrativo</a>
                    </nav>
